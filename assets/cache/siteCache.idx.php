...
`+]';$c['AjaxSearch_tplAjaxGrpResult'] = '[+as.grpResultsDef:is=`1`:then=`
...
`+]';$c['Comments_tplForm'] = '<a name="jf[+jot.link.id+]"></a>
...
</form>';$c['AjaxSearch_tplAjaxResults'] = '<div id="search_results" class="modal fade" tabindex="-1" role="dialog">
...
<script>$(\'#search_results\').modal(\'show\')</script>';$c['Comments_tplComments'] = '<a name="jc[+jot.link.id+][+comment.id+]"></a>
...
`+]
</div>';$c['mm_rules'] = '// more example rules are in assets/plugins/managermanager/example_mm_rules.inc.php
...
';$c['HEAD'] = '<head>
    ...
    <![endif]-->
</head>';$c['WARNING'] = '<noscript><div class="error-js"><strong>Для полной функциональности этого сайта необходимо включить JavaScript.</strong> Вот <a href="http://artjoker.ua/ru/how-to-enable-javascript/" target="_blank">инструкции</a>, как включить JavaScript в вашем браузере.</div></noscript>
    <!--[if lte IE 8]>
      <p class="off-js">Ваш браузер устарел, пожалуйста <b>обновите</b> его.</p>
    <![endif]-->';$c['HEADER'] = '<header id="header">
  <div class="container">
...
</header>';$c['slider'] = '<section class="slider">
...
</section>';$c['services'] = '<section class="services animated" data-animation="fadeInUp" data-animation-delay="600">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
...
</section>';$c['about_main'] = '<section class="about_index">
  <div class="container">
...
</footer>';$c['MODAL'] = '<div id="thank" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
...
</div>';$c['about_pagetitle'] = '<section class="pagetitle">
  <div class="container">
    <div class="col-sm-12">
...
</section>';$c['main_at_page_about'] = '<div class="main wrap_about">
...
</div>';$c['news_at_about_page'] = '<div id="news" class="col-sm-12 news_block">
  <div class="col-sm-12">
...
</div>';$c['benefits_about'] = '<div id="benefits" class="col-sm-12">
  <div class="col-sm-12">
...
</div>';$c['contacts_title'] = '<section class="pagetitle">
<div class="container">
  <div class="col-sm-12">
    <strong class="title animated" data-animation="fadeInRight" data-animation-delay="600">Контакты</strong>
  </div>
</div>
</section>';$c['map_contacts'] = '<section class="map animated" data-animation="fadeIn" data-animation-delay="600">
...
</section>';$c['contacts_main'] = '<div class="main contacts">
  <div class="container animated" data-animation="fadeInUp" data-animation-delay="600">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        {{LAST_NEWS}}
...
</div>';$c['LAST_NEWS'] = '<div class="col-md-4 col-sm-4 col-xs-12">
          <strong class="heading">Последние новости</strong>
          ...
          <a href="[~5~]" class="btn btn_transp details">Все новости</a>
        </div>';$c['news_article'] = '<div class="one_news">	
...
</div>';$c['news'] = '<div>[[Ditto? &id=`nav` &tpl=`news_article` &dateSource=`pub_date` &dateFormat=`%d.%m.%Y` &paginate=`1` &display=`3` &paginateAlwaysShowLinks=`1` &tplPaginatePage=`PAGINATION_PAGE` &tplPaginatePrevious=`PAGINATION_PREV`     &tplPaginateNext=`PAGINATION_NEXT` &tplPaginateCurrentPage=`PAGINATION_CURRENT` &tplPaginateNextOff=`PAGINATION_NEXT_OFF`     &tplPaginatePreviousOff=`PAGINATION_PREV_OFF`]]</div>
<div><nav class="pages_block"><ul class="pagination">[+nav_previous+][+nav_pages+][+nav_next+]</ul></nav></div>';$c['PAGINATION_CURRENT'] = '<li><span class=\'\'>[+page+]</span></li>';$c['PAGINATION_NEXT'] = '<li><a href="[+url+]" class=\'next\'>[+lang:next+]</a></li>';$c['PAGINATION_NEXT_OFF'] = '<li><span class=\'\'>[+lang:next+]</span></li>';$c['PAGINATION_PAGE'] = '<li><a href=\'[+url+]\'>[+page+]</a></li>';$c['PAGINATION_PREV'] = '<li><a href="[+url+]" class=\'prev\'>[+lang:previous+]</a></li>';$c['PAGINATION_PREV_OFF'] = '<li><span class=\'\'>[+lang:previous+]</span></li>';$c['about_company'] = '<div id="about" class="col-sm-12">
...
</div>';$c['about_mission'] = '<div id="mission" class="col-sm-12">
  <div class="col-sm-12">
...
</div>';$c['feedback_block'] = '<div class="feedback_block form">
  <div class="col-sm-12">
...
</div>';$c['pagination'] = '<nav class="pages_block">
  <ul class="pagination">
    <li class="prev">
      <a href="#">
...
</nav>';$c['news_page_title'] = '<section class="pagetitle">
<div class="container">
  <div class="col-sm-12">
    <strong class="title animated" data-animation="fadeInRight" data-animation-delay="600">Новости</strong>
  </div>
</div>
</section>';$c['main_news'] = '<div class="main news">
  <div class="container animated" data-animation="fadeInUp" data-animation-delay="600">
    <div class="row">
      <div class="col-sm-12">
        <div class="col-md-8 col-sm-8 col-xs-12">
...
</div>';$c['MAIN_MENU'] = '[!Wayfinder? &outerClass=`nav navbar-nav navbar-right` &innerClass=`dropdown-menu`&startId=`0` !]               ';$s=&$this->snippetCache;$s['UltimateParent']='return require MODX_BASE_PATH.\'assets/snippets/ultimateparent/snippet.ultimateparent.php\';';$s['Wayfinder']='return require MODX_BASE_PATH.\'assets/snippets/wayfinder/snippet.wayfinder.php\';';$s['WebLogin']='return require MODX_BASE_PATH.\'assets/snippets/weblogin/snippet.weblogin.php\';';$s['WebLoginProps']='{"loginhomeid":"","logouthomeid":"","logintext":"","logouttext":"","tpl":""}';$s['Personalize']='return require MODX_BASE_PATH.\'assets/snippets/personalize/snippet.personalize.php\';';$s['eForm']='return require MODX_BASE_PATH.\'assets/snippets/eform/snippet.eform.php\';';$s['AjaxSearch']='return require MODX_BASE_PATH.\'assets/snippets/ajaxSearch/snippet.ajaxSearch.php\';';$s['WebSignup']='/**
 * WebSignup
 * 
...
# Return
return $output;';$s['WebSignupProps']='{"tpl":""}';$s['phpthumb']='return require MODX_BASE_PATH.\'assets/snippets/phpthumb/snippet.phpthumb.php\';';$s['WebChangePwd']='/**
 * WebChangePwd
 * 
...
return require MODX_BASE_PATH.\'assets/snippets/reflect/snippet.reflect.php\';';$s['MemberCheck']='return require MODX_BASE_PATH.\'assets/snippets/membercheck/snippet.membercheck.php\';';$s['Ditto']='return require MODX_BASE_PATH.\'assets/snippets/ditto/snippet.ditto.php\';';$s['if']='return require MODX_BASE_PATH.\'assets/snippets/if/snippet.if.php\';';$s['Jot']='/**
 * Jot
 * 
